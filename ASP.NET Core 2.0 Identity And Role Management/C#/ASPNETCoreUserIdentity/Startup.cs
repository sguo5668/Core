...
namespace ASPNETCoreUserIdentity
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IServiceProvider services)
        {
            ...
            app.UseMvc(routes =>
            {
		 	...
		 	CreateUserRoles(services).Wait();  // disable this line before db is created
        // to get db created, we need to register a user first and then update-database
		}
 ...
 //Asign Admin role to the main User here i have given my login id for Admin management
			ApplicationUser user = await UserManager.FindByEmailAsync("sguo5668@gmail.com");
